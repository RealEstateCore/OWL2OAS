...
namespace IO.Swagger.Model {
  ...
  public class Building {
    ...
    /// </summary>
    [DataMember(Name="hasBuildingComponent", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "hasBuildingComponent")]
    public List<BuildingComponent> HasBuildingComponent { get; set; }

    /// <summary>
    /// Gets or Sets HasGeoReferenceOrigo
    /// </summary>
